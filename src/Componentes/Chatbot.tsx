...
const Chatbot: React.FC = () => {
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      setMessages([`<div style="display: flex; align-items: center;"><img src="../src/img/favicon.png" alt="favicon" style="width: 20px; height: 20px; margin-right: 5px;" /><strong>Laguito:</strong> ${welcomeMessage}</div>`]);
    }
  }, [isOpen]);
