    ...
    <nav className="navbar">
      <div className="navbar-container">
        ...
        <ul className={`nav-menu ${isActive ? 'active' : ''}`}>
          ...
          <li className="nav-item">
            <Link to="/noticias" className="nav-links" onClick={toggleMenu}>
              Noticias
            </Link>
          </li>
          {role !== 'directiva' && (
          ...
          {isAuthenticated && (
            <>
              {role === 'directiva' && (
                <>
                  <li className="nav-item">
                    <Link to="/crearActividades" className="nav-links" onClick={toggleMenu}>
                      Crear
                    </Link>
                  </li>
                  <li className="nav-item">
                    <Link to="/lup" className="nav-links" onClick={toggleMenu}>
                      Lup
                    </Link>
                  </li>
                  <li className="nav-item">
                    <Link to="/usersList" className="nav-links" onClick={toggleMenu}>
                      Usuarios
                    </Link>
                  </li>
                  <li className="nav-item">
                    <Link to="/grafico" className="nav-links" onClick={toggleMenu}>
                      <FaChartBar />
                    </Link>
                  </li>
                </>
              ...
              {role === 'vecino' && (
                <>
                  <li className="nav-item">
                    <Link to="/solicitudes" className="nav-links" onClick={toggleMenu}>
                      Solicitudes
                    </Link>
                  </li>
                  <li className="nav-item">
                    <Link to="/actividades" className="nav-links" onClick={toggleMenu}>
                      Participa
                    </Link>
                  </li>
                  <li className="nav-item">
                    <Link to="/videos" className="nav-links" onClick={toggleMenu}>
                      Videos Tutoriales
                    </Link>
                  </li>
                </>
          ...
          {isAuthenticated && (
            <li className="nav-item user-name">Usuario: {userName}</li>
          )}
